...
public final class SpawnResolveEvent extends Event implements Cancellable {
    ...
    public SpawnResolveEvent(Player player, SpawnReason reason, SpawnTarget target) {
        this.player = player;
        this.reason = reason;
        this.target = target;
    }
    ...
    public void setTarget(SpawnTarget target) { this.target = target; }
